...
\title{Silent error analysis in linear pipelines}
...
\input{Parts/3_density_comparaison.tex}
\input{Parts/4_density_estimation_methods.tex}
\input{Parts/5_error_modelisation.tex}
% \input{Parts/6_results_analysis.tex}
