...
computation with a different method if $2\times10^4$ particles or more are
affected, as we this distance to be twice the inter-method threshold to be
clearly noticeable. Compared to our $1.92\times10^7$ bits input data size, this
gives us a detectable corruption rate thresold of about $0.05\%$
