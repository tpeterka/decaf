#=============================================================================
#
# The following is copied with permission (per the terms of the Apache 2.0 license) from
#
# https://github.com/bwhite/picarus_takeout/blob/master/cmake/UseCython.cmake
# https://github.com/Kitware/CMake/blob/master/Modules/FindPythonLibs.cmake
# https://github.com/bwhite/picarus_takeout/blob/master/cmake/FindCython.cmake
#
# minor modifications were made by Tom Peterka
#
#=============================================================================
#
    ...
    while( ${number_pxds_to_check} GREATER 0 )
      foreach( pxd ${pxds_to_check} )
        ...
        foreach( statement ${extern_from_statements} )
          ...
          string( REGEX REPLACE "cdef[ ]+extern[ ]+from[ ]+[\"]([^\"]+)[\"].*" "\\1"
            header "${statement}" )
...
# the module is built as a shared object
function( python_add_module _NAME )
  option( PYTHON_ENABLE_MODULE_${_NAME} "Add module ${_NAME}" TRUE )
  option( PYTHON_MODULE_${_NAME}_BUILD_SHARED "Add module ${_NAME} shared" TRUE )
