...
FIND_LIBRARY(DECAF_CXX_DATA_TRANSPORT_MPI_LIBRARY NAMES bredala_transport_mpi HINTS
  ${DECAF_PREFIX}/lib
  /usr/lib
  /usr/local/lib
  /opt/local/lib
...
IF(DECAF_CXX_DATA_TRANSPORT_MPI_LIBRARY)
  LIST(APPEND DECAF_CXX_TRANSPORT_LIBRARY ${DECAF_CXX_DATA_TRANSPORT_MPI_LIBRARY})
ENDIF(DECAF_CXX_DATA_TRANSPORT_MPI_LIBRARY)

FIND_LIBRARY(DECAF_CXX_DATA_TRANSPORT_CCI_LIBRARY NAMES bredala_transport_cci HINTS
  ${DECAF_PREFIX}/lib
  /usr/lib
  /usr/local/lib
  /opt/local/lib
...
IF(DECAF_CXX_DATA_TRANSPORT_CCI_LIBRARY)
  LIST(APPEND DECAF_CXX_TRANSPORT_LIBRARY ${DECAF_CXX_DATA_TRANSPORT_CCI_LIBRARY})
ENDIF(DECAF_CXX_DATA_TRANSPORT_CCI_LIBRARY)
