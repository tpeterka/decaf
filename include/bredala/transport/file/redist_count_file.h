...
#ifndef DECAF_REDIST_COUNT_FILE_HPP
#define DECAF_REDIST_COUNT_FILE_HPP
...
namespace decaf
{
    ...
    class RedistCountFile : public RedistFile
    {
    public:

    RedistCountFile() :
        RedistFile() {}
    RedistCountFile(int rankSource,
                   int nbSources,
                   int rankDest,
                   int nbDests,
                   int global_rank,
