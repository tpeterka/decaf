...
#ifndef DECAF_REDIST_COUNT_CCI_HPP
#define DECAF_REDIST_COUNT_CCI_HPP
...
namespace decaf
{
    ...
    class RedistCountCCI : public RedistCCI
    {
    public:

    RedistCountCCI() :
        RedistCCI() {}
    RedistCountCCI(int rankSource,
                   int nbSources,
                   int rankDest,
                   int nbDests,
                   int global_rank,
