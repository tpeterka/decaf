...
w.add_edge('node0', 'node1', start_proc=4, nprocs=3, func='dflow', path=mod_path, transport="file",
           prod_dflow_redist='count', dflow_con_redist='count', cmdline='./linear_3nodes')
w.add_edge('node1', 'node2', start_proc=9, nprocs=2, func='dflow', path=mod_path, transport="file",
           prod_dflow_redist='count', dflow_con_redist='count', cmdline='./linear_3nodes')
