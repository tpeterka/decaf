...
driver_path = os.environ['DECAF_PREFIX'] + '/examples/direct/pybind11/py_linear_2nodes.so'
...
w.add_edge("prod", "con", start_proc=0, nprocs=4, func='dflow', path=mod_path, prod_dflow_redist='count', dflow_con_redist='count')
