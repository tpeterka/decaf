...
# Creating the graph
w = nx.DiGraph()
w.add_node("reader", topology=subtopos[0], func='prod', cmdline='./filereader filelist_ 0 2')
w.add_node("con", topology=subtopos[2], func='con', cmdline='./con_buffer')
w.add_edge("reader", "con", topology=subtopos[1], func='dflow', path=mod_path,
           prod_dflow_redist='count', dflow_con_redist='count', cmdline='./dflow_buffer')

wf.addDirectSyncStream(w, "reader", "con")
