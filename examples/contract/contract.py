...
w.add_edge("prod1", "con1", topology=subtopos[4], prod_dflow_redist='count', dflow_con_redist='count', func='dflow', path=mod_path, cmdline='contract')
w.add_edge("prod1", "con2", topology=subtopos[5], prod_dflow_redist='count', dflow_con_redist='count', func='dflow', path=mod_path, cmdline='contract')
w.add_edge("prod2", "con1", topology=subtopos[6], prod_dflow_redist='count', dflow_con_redist='count', func='dflow', path=mod_path, cmdline='contract')
w.add_edge("prod2", "con2", topology=subtopos[7], prod_dflow_redist='count', dflow_con_redist='count', func='dflow', path=mod_path, cmdline='contract')
